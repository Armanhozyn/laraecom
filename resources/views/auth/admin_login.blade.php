							...
							<form method="POST" action="{{ isset($guard) ? route('admin.login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input  id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email" type="email" name="email" :value="old('email')" required autofocus>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" type="password" name="password" required autocomplete="current-password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
